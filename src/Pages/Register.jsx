...
function Register() {
  ...
  const navigate = useNavigate("");
    ...
    const register = (e)=>{
      ...
      const userSignup= createUserWithEmailAndPassword(auth, email,password)
      navigate('/')
    }

  return (
    <div className="register">
            <img src="https://logos-world.net/wp-content/uploads/2020/05/Facebook-Logo.png" className="register_logo" />
